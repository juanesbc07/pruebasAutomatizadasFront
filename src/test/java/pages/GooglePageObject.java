...
public class GooglePageObject extends PageObject {
    ...
    public SheetModel readSheetAndWriteOnSearchField(Integer rowNumber){
        ...
        try {
            ...
            sheetModel.setTermino(String.valueOf((values).get(rowNumber).get(0)));
            sheetModel.setName(String.valueOf((values).get(rowNumber).get(1)));
            sheetModel.setCountry(String.valueOf((values).get(rowNumber).get(2)));
            sheetModel.setCity(String.valueOf((values).get(rowNumber).get(3)));
            sheetModel.setCard(String.valueOf((values).get(rowNumber).get(4)));
            sheetModel.setMonth(String.valueOf((values).get(rowNumber).get(5)));
            sheetModel.setYear(String.valueOf((values).get(rowNumber).get(6)));
            sheetModel.setUserName(String.valueOf((values).get(rowNumber).get(7)));
            sheetModel.setPassword(String.valueOf((values).get(rowNumber).get(8)));
            sheetModel.setSection(String.valueOf((values).get(rowNumber).get(9)));
